...
"</EE_EAI_MESSAGE>";
		...
		String DCC_FTS_update="<EE_EAI_MESSAGE>"+"\n"+
				...
				"    <ReturnCode>9999</ReturnCode>"+"\n"+
				"    <ReturnDesc>Request</ReturnDesc>"+"\n"+
				"    <MessageId>RPA1VKNI1676026387067</MessageId>"+"\n"+
				"    <Extra1>REQ||RAK.VTUSER</Extra1>"+"\n"+
				"    <Extra2>2023-02-10T14:53:07.067+05:30</Extra2>"+"\n"+
				"  </EE_EAI_HEADER>"+"\n"+
				"  <UpdateWorkitemReq>"+"\n"+
				"    <ProcessName>Digital_CC</ProcessName>"+"\n"+
				...
				"      <Attribute>"+"\n"+
				"        <Name>WINUMBER</Name>"+"\n"+
				"        <Value>DCC-0000006512-process</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>Prospect_id</Name>"+"\n"+
				"        <Value>80689</Value>"+"\n"+
				...
				"        <Value>11000.00</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>Stmt_salary1_date</Name>"+"\n"+
				"        <Value>2023-02-04</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>Stmt_salary_2</Name>"+"\n"+
				"        <Value>11059.00</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				...
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>Stmt_salary_4</Name>"+"\n"+
				"        <Value>11000.00</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>Stmt_salary4_date</Name>"+"\n"+
				...
				"        <Value>2022-10-08</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>Stmt_salary_6</Name>"+"\n"+
				"        <Value>4000.00</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>Stmt_salary6_date</Name>"+"\n"+
				"        <Value>2022-09-17</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
		...
		String CPMS= "<EE_EAI_MESSAGE>"+"\n"+
				...
				"    <ReturnCode>0000</ReturnCode>"+"\n"+
				"    <ReturnDesc>0000</ReturnDesc>"+"\n"+
				"    <MessageId>Test19312123374445</MessageId>"+"\n"+
				"    <Extra1>REQ || DEH.123</Extra1>"+"\n"+
				"    <Extra2>2011-02-08T15:31:38.818+05:30</Extra2>"+"\n"+
				"  </EE_EAI_HEADER>"+"\n"+
				"  <CreateWorkitemReq>"+"\n"+
				"    <ProcessName>CPMS</ProcessName>"+"\n"+
				"    <SubProcessName>CCS.GAD</SubProcessName>"+"\n"+
				"    <InitiateAlso>N</InitiateAlso>"+"\n"+
				"    <Attributes>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>CIF_ID_CustomerDetails</Name>"+"\n"+
				"        <Value>1234567</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>MobileNo_CustomerDetails</Name>"+"\n"+
				"        <Value>0097158671995376</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
				"        <Name>ISRAKCustomer</Name>"+"\n"+
				"        <Value>Y</Value>"+"\n"+
				"      </Attribute>"+"\n"+
				"      <Attribute>"+"\n"+
		...
		System.out.println("iRBLMessage : "+DCC_FTS_update);
		String response =new CreateWorkitem().getResponseOffshore(CPMS);
